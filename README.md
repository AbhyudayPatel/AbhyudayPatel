...
<p>GPT-2 in NumPy, end to end: BPE → attention → KV cache → batching → FastAPI serving.</p>
<p>A hands-on lab for how serving engines work.</p>
<p><code>NumPy</code> <code>KV cache</code> <code>FastAPI</code></p>
<p><a href="https://github.com/AbhyudayPatel/Inference_from_scratch"><strong>GitHub ↗</strong></a> · <a href="https://github.com/AbhyudayPatel/Inference_from_scratch/tree/master/Day05_Serving_An_Engine">Serving code</a></p>
...
<p>PyPI framework for <strong>1–10 voice agents</strong> — debates, panels, interviews, personas, turn-taking.</p>
<p><code>LiveKit</code> <code>Gemini</code> <code>MIT</code></p>
<p><a href="https://github.com/AbhyudayPatel/DuoTalk"><strong>GitHub ↗</strong></a> · <a href="https://youtu.be/KxT4Xm6kKZ8"><strong>▶ Demo</strong></a> · <a href="https://pypi.org/project/duotalk/">PyPI</a></p>

</td>
<td width="50%" valign="top">

<h3>📦 <a href="https://github.com/AbhyudayPatel/Procurv">Procurv</a></h3>
<p><strong>10 agent tools</strong> for procurement — RFPs, outreach, reverse auctions, reports. OAuth + billing + deploys.</p>
<p>Wound down, fully open-sourced.</p>
<p><a href="https://github.com/AbhyudayPatel/Procurv"><strong>GitHub ↗</strong></a> · <a href="https://youtu.be/jzp-LK5PZCg"><strong>▶ Demo</strong></a> · <a href="https://www.procurvhq.com">Site</a></p>
...
<div align="center">
  <img src="./assets/github-metrics.svg" width="100%" alt="Live GitHub metrics — contributions, languages, and activity" />
</div>

<div align="center">
  <img src="https://streak-stats.demolab.com?user=AbhyudayPatel&amp;theme=github-dark-blue&amp;hide_border=true" width="68%" alt="Contribution streak" />
</div>
...
<div align="center">
<img src="https://skillicons.dev/icons?i=python,ts,go,fastapi,nextjs,pytorch,tensorflow,postgres" alt="Python, TypeScript, Go, FastAPI, Next.js, PyTorch, TensorFlow, PostgreSQL" /><br />
<img src="https://skillicons.dev/icons?i=docker,kubernetes,azure,aws,gcp,linux,git,githubactions" alt="Docker, Kubernetes, Azure, AWS, GCP, Linux, Git, GitHub Actions" />
</div>
